...
class Main extends Component {
    ...
    render() {
        ...
        let input_json = [this.state.input]
        // const annotations = [
        //     { type: "x", week: "2", note: { label: "2nd week always has a lower income", align: "middle" }, color: "rgb(0, 162, 206)", dy: -10, dx: 0, connector: { end: "none" } },
        // ]
        ...
        return (
            <div className="main-container">
                ...
                <div className="input-container">
                    <Textarea className="textarea-field" value={this.state.input} onChange={this.handleInput}></Textarea>
                    <br/>
